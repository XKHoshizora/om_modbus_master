...
// MODIFIED: Changed from tf to tf2
#include <tf2_ros/transform_broadcaster.h>
#include <tf2/LinearMath/Quaternion.h>
// ADDED: For static transform broadcaster
...
// ADDED: Define the height of the robot base
const double ROBOT_BASE_HEIGHT = 0.1; // Adjust this value according to your robot's specifications
...
int main(int argc, char** argv) {
    ...
    // MODIFIED: Changed from tf::TransformBroadcaster to tf2_ros::TransformBroadcaster
    tf2_ros::TransformBroadcaster odom_broadcaster;
    // ADDED: Static transform broadcaster for base_footprint to base_link
    ...
    while (ros::ok()) {
        ...
        // MODIFIED: Changed to publish odom to base_footprint transform
        ...
        odom_trans.transform.translation.z = 0.0;  // base_footprint is on the ground
        tf2::Quaternion q;
        q.setRPY(0, 0, odm_th);
        ...
        // MODIFIED: Changed child_frame_id to base_footprint
